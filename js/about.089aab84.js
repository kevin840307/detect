 ...
 * =============================================================================
 */
function qt({a:e,b:t,transposeA:n,transposeB:i,backend:r,bias:o=null,preluActivationWeights:a=null,leakyreluAlpha:s=0,activation:l=null}){const h=e.shape.length,d=t.shape.length,c=n?e.shape[h-2]:e.shape[h-1],p=i?t.shape[d-1]:t.shape[d-2],f=n?e.shape[h-1]:e.shape[h-2],m=i?t.shape[d-2]:t.shape[d-1],g=e.shape.slice(0,-2),y=t.shape.slice(0,-2),x=u.ZSL.sizeFromShape(g),b=u.ZSL.sizeFromShape(y),w=u.ZEY.assertAndGetBroadcastShape(e.shape.slice(0,-2),t.shape.slice(0,-2)),v=w.concat([f,m]);u.ZSL.assert(c===p,(()=>`Error in matMul: inner shapes (${c}) and (${p}) of Tensors with shapes ${e.shape} and ${t.shape} and transposeA=${n} and transposeB=${i} must match.`));const S=n?[x,c,f]:[x,f,c],k=i?[b,m,p]:[b,p,m],C=Kt({inputs:{x:e},backend:r,attrs:{shape:S}}),I=Kt({inputs:{x:t},backend:r,attrs:{shape:k}}),R=[C,I],P=Math.max(x,b),z=[C,I],T=[{type:"int32",data:[f]},{type:"int32",data:[m]},{type:"int32",data:[c]}];let A,L;const E=[P,f,m];let $=(0,u._K2)().get("WEBGPU_MATMUL_PROGRAM_TYPE");if($<0){const e=(0,u._K2)().getNumber("WEBGPU_THRESHOLD_TO_INCREASE_WORKGROUPS_FOR_MATMUL"),t=e>0?e:r.thresholdToIncreaseWorkgroups,n=P*Math.ceil(f/32)*Math.ceil(m/32),i=n<=t||f<=8&&n<=2*t;$=i?P*f*m<=128?Z.MatMulReduceProgram:1===P&&p>=2e3?Z.MatMulSplitKProgram:Z.MatMulSmallOutputSizeProgram:Z.MatMulPackedProgram}switch($){case Z.MatMulReduceProgram:A=new Ot(E,n,i,o,l,a);break;case Z.MatMulSplitKProgram:if(L=Gt({backend:r,attrs:{shape:E,value:0,dtype:e.dtype}}),A=new Wt(E,p,n,i),o||l){L=r.runWebGPUProgram(A,z,e.dtype,T,L);const t=new Vt(L.shape,o,l,a);let n=null;const i=[L];o&&i.push(o),a&&i.push(a),"leakyrelu"===l&&(n=[{type:"float32",data:[s]}],t.uniforms+=" alpha : f32,");const u=r.runWebGPUProgram(t,i,L.dtype,n);R.push(L);const h=Kt({inputs:{x:u},backend:r,attrs:{shape:v}});R.push(u);for(const e of R)r.disposeData(e.dataId);return h}break;case Z.MatMulSmallOutputSizeProgram:A=new Ut(S,k,E,n,i,o,l,a);break;case Z.MatMulPackedProgram:const t=r.adapterInfo.isIntel();A=new _t(S,E,n,i,o,l,a,t);break;default:throw new Error(`Unsupported MatMulProgramType ${$}.`)}o&&z.push(o),a&&z.push(a),"leakyrelu"===l&&(T.push({type:"float32",data:[s]}),A.uniforms+=" alpha : f32,"),L=r.runWebGPUProgram(A,z,e.dtype,T,L);const F=Kt({inputs:{x:L},backend:r,attrs:{shape:v}});R.push(L);for(const u of R)r.disposeData(u.dataId);return F}
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
const{mx:ln,ct:hn,YG:dn,hH:cn,z3:pn,sG:fn,uM:mn,vS:gn,C1:yn,qB:xn,GG:bn,lg:wn,rq:vn,cu:Sn,WR:kn,px:Cn,jC:In,He:Rn,hE:Pn,BF:zn,Dk:Tn,cl:An,_B:Ln,qy:En,Zy:$n,bu:Fn,dH:Nn,HS:Dn,eW:_n,GK:Mn,dl:On,Dw:Bn,xT:Un,_X:Wn,wz:Vn}=un,Hn=an({opType:Ee.ABS,cpuKernelImpl:Nn}),Gn={kernelName:u.ljI,backendName:"webgpu",kernelFunc:Hn},jn=an({opType:Ee.ACOS}),Kn={kernelName:u.Vvy,backendName:"webgpu",kernelFunc:jn},Xn=an({opType:Ee.ACOSH}),qn={kernelName:u.PH8,backendName:"webgpu",kernelFunc:Xn},Yn=sn({opType:te.ADD,cpuKernelImpl:ln,supportsComplex:!0}),Zn={kernelName:u.OMN,backendName:"webgpu",kernelFunc:Yn};
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function sr(e){const{inputs:t,backend:n}=e,{s0:i,s1:r}=t;if(n.shouldExecuteOnCPU([i,r])){const e=n.tensorMap.get(i.dataId),t=n.tensorMap.get(r.dataId),o=e.values,a=t.values,s=u.C0T.assertAndGetBroadcastShape(Array.from(o),Array.from(a));return n.makeTensorInfo([s.length],"int32",Int32Array.from(s))}const o=u.ZSL.sizeFromShape(i.shape),a=u.ZSL.sizeFromShape(r.shape),s=Math.max(o,a),l=new ar(s),h=[{type:"int32",data:[o]},{type:"int32",data:[a]}];return n.runWebGPUProgram(l,[i,r],"int32",h)}const ur={kernelName:u.vj7,backendName:"webgpu",kernelFunc:sr},lr=sn({opType:te.NOT_EQUAL,dtype:"bool",cpuKernelImpl:An}),hr={kernelName:u.ylV,backendName:"webgpu",kernelFunc:lr};
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Tr(e,t,n){const i=e[0].dtype;if("complex64"===i){const i=e.map((e=>dr({inputs:{input:e},backend:n}))),r=e.map((e=>Pr({inputs:{input:e},backend:n}))),o=Tr(i,t,n),a=Tr(r,t,n),s=nn({inputs:{real:o,imag:a},backend:n});return i.forEach((e=>n.disposeData(e.dataId))),r.forEach((e=>n.disposeData(e.dataId))),n.disposeData(o.dataId),n.disposeData(a.dataId),s}let r=n.shouldExecuteOnCPU(e);if("string"===i&&(r=!0),r){const r=e.map((e=>{const i=u.ZSL.sizeFromShape(e.shape.slice(t)),r=[-1,i];return Kt({inputs:{x:e},backend:n,attrs:{shape:r}})})),o=r.map((e=>({vals:n.readSync(e.dataId),shape:e.shape}))),a=u.C0T.computeOutShape(r.map((e=>e.shape)),1),s=1===r[0].shape[0],l=cn(o,a,i,s),h=u.C0T.computeOutShape(e.map((e=>e.shape)),t),d=n.makeTensorInfo(h,i,l);return r.forEach((e=>n.disposeData(e.dataId))),d}const o=n.device.limits.maxStorageBuffersPerShaderStage-1;if(e.length>o){const i=[];for(let a=0;a<e.length;a+=o){const r=e.slice(a,a+o);i.push(Tr(r,t,n))}const r=Tr(i,t,n);for(const e of i)n.disposeData(e.dataId);return r}const{tensors2D:a,outShape:s}=Ar(e,t,n),l=a.map((e=>e.shape)),h=new Rr(l),d=[],c=new Array(l.length-1);if(c.length>0){c[0]=l[0][1],d.push({type:"int32",data:[c[0]]});for(let e=1;e<c.length;e++)c[e]=c[e-1]+l[e][1],d.push({type:"int32",data:[c[e]]})}const p=n.runWebGPUProgram(h,a,a[0].dtype,d);a.forEach((e=>n.disposeData(e.dataId)));const f=Kt({inputs:{x:p},backend:n,attrs:{shape:s}});return n.disposeData(p.dataId),f}function Ar(e,t,n){const i=u.C0T.computeOutShape(e.map((e=>e.shape)),t),r=e.map((e=>Kt({inputs:{x:e},backend:n,attrs:{shape:[u.ZSL.sizeFromShape(e.shape.slice(0,t)),u.ZSL.sizeFromShape(e.shape.slice(t))]}})));return{tensors2D:r,outShape:i}}
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Lr(e){const{inputs:t,backend:n,attrs:i}=e,{axis:r}=i,o=u.ZSL.parseAxisParam(r,t[0].shape)[0],a=t.map((e=>e.shape));u.C0T.assertParamsConsistent(a,o);const s=u.C0T.computeOutShape(t.map((e=>e.shape)),o);if(0===u.ZSL.sizeFromShape(s))return n.makeTensorInfo(s,t[0].dtype,[]);const l=t.filter((e=>u.ZSL.sizeFromShape(e.shape)>0));return 1===l.length?en({inputs:{x:l[0]},backend:n}):Tr(l,o,n)}const Er={kernelName:u.$dB,backendName:"webgpu",kernelFunc:Lr};
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function zs(e){const{inputs:t,backend:n,attrs:i}=e,{x:r}=t,{depthRadius:o,bias:a,alpha:s,beta:u}=i;let l;l=o>16?new Rs(r.shape):new Ps(r.shape,o);const h=[{type:"int32",data:[o]},{type:"float32",data:[a]},{type:"float32",data:[s]},{type:"float32",data:[u]}],d=n.runWebGPUProgram(l,[r],r.dtype,h);return d}const Ts={kernelName:u.jM4,backendName:"webgpu",kernelFunc:zs};
/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ls(e){const{inputs:t,backend:n,attrs:i}=e,{x:r,y:o,dy:a}=t,{depthRadius:s,bias:u,alpha:l,beta:h}=i,d=new As(r.shape),c=[{type:"int32",data:[s]},{type:"float32",data:[u]},{type:"float32",data:[l]},{type:"float32",data:[h]}],p=n.runWebGPUProgram(d,[r,o,a],r.dtype,c);return p}const Es={kernelName:u.ToN,backendName:"webgpu",kernelFunc:Ls},$s=sn({opType:te.MAX,cpuKernelImpl:Rn}),Fs={kernelName:u.LDN,backendName:"webgpu",kernelFunc:$s};
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function _s(e){const{inputs:t,backend:n,attrs:i}=e,{x:r}=t,{filterSize:o,strides:a,pad:s,dataFormat:l,dimRoundingMode:h}=i,d=[1,1,1],c=u.C0T.computePool3DInfo(r.shape,o,a,d,s,h,l),p=new Ai(c,"max"),f=[{type:"int32",data:[c.strideDepth,c.strideHeight,c.strideWidth]},{type:"int32",data:[c.padInfo.front,c.padInfo.top,c.padInfo.left]},{type:"int32",data:[c.inDepth,c.inHeight,c.inWidth]},{type:"int32",data:[c.effectiveFilterDepth,c.effectiveFilterHeight,c.effectiveFilterWidth]}];return n.runWebGPUProgram(p,[r],r.dtype,f)}const Ms={kernelName:u.ySp,backendName:"webgpu",kernelFunc:_s};
/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function su(e){const{inputs:t,backend:n}=e,{x:i}=t;if(n.shouldExecuteOnCPU([i])){const e=n.tensorMap.get(i.dataId),[t,r]=Tn(e.values,i.shape,i.dtype);return n.makeTensorInfo(r,i.dtype,t)}const r=new on(i.shape,Ee.NEG);return n.runWebGPUProgram(r,[i],i.dtype)}const uu={kernelName:u.l0G,backendName:"webgpu",kernelFunc:su};
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function zu(e){const{inputs:t,backend:n}=e,{x:i,alpha:r}=t,o=new Jt(te.PRELU,i.shape,r.shape);return n.runWebGPUProgram(o,[i,r],"float32")}const Tu={kernelName:u.Ncv,backendName:"webgpu",kernelFunc:zu};
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function gl(e){const{inputs:t,backend:n}=e,{condition:i,t:r,e:o}=t,a=new ml(i.shape.length,r.shape,r.shape.length);return n.runWebGPUProgram(a,[i,r,o],(0,u.TuY)(r.dtype,o.dtype))}const yl={kernelName:u.l6P,backendName:"webgpu",kernelFunc:gl},xl=an({opType:Ee.SELU}),bl={kernelName:u.u$b,backendName:"webgpu",kernelFunc:xl},wl=an({opType:Ee.SIGMOID}),vl={kernelName:u.vI1,backendName:"webgpu",kernelFunc:wl},Sl=an({opType:Ee.SIGN}),kl={kernelName:u.YVe,backendName:"webgpu",kernelFunc:Sl},Cl=an({opType:Ee.SIN}),Il={kernelName:u.hql,backendName:"webgpu",kernelFunc:Cl},Rl=an({opType:Ee.SINH}),Pl={kernelName:u.J3C,backendName:"webgpu",kernelFunc:Rl},zl=an({opType:Ee.SOFTPLUS}),Tl={kernelName:u.Fin,backendName:"webgpu",kernelFunc:zl};
/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ph(e){const{inputs:t,backend:n,attrs:i}=e,{x:r,segmentIds:o}=t,{numSegments:a}=i,s=r.shape.length,l=[];let h=0;const d=u.C0T.getAxesPermutation([h],s);let c=r;null!=d&&(c=ri({inputs:{x:r},backend:n,attrs:{perm:d}}),l.push(c),h=u.C0T.getInnerMostAxes(1,s)[0]);const p=u.C0T.segment_util.computeOutShape(c.shape,h,a),f=u.ZSL.sizeFromShape([c.shape[h]]),m=Kt({inputs:{x:c},backend:n,attrs:{shape:[-1,f]}});l.push(m);const g=r.dtype,y=[m.shape[0],a],x=Gt({backend:n,attrs:{shape:y,value:0,dtype:g}}),b=new Rh(m.shape,y,g),w=[{type:"int32",data:[a]},{type:"int32",data:[u.ZSL.sizeFromShape(m.shape)]}],v=n.runWebGPUProgram(b,[m,o],g,w,x),S=Kt({inputs:{x:v},backend:n,attrs:{shape:p}});l.push(v);let k=S;if(null!=d){l.push(S);const e=u.C0T.getUndoAxesPermutation(d);k=ri({inputs:{x:k},backend:n,attrs:{perm:e}})}return l.forEach((e=>n.disposeData(e.dataId))),k}const zh={kernelName:u.pPe,backendName:"webgpu",kernelFunc:Ph},Th=[Zt,Gn,Kn,qn,Zn,ei,hi,ci,mi,yi,bi,vi,ki,Ii,Pi,_i,Oi,Vi,Gi,Ki,er,or,ur,mr,yr,vr,rn,Ir,Er,Wr,Xr,Qr,to,io,oo,so,lo,po,wo,So,Co,Po,Do,Mo,Eo,Uo,Ho,Xo,Yo,Jo,oa,sa,la,da,pa,ma,ya,ba,ka,jt,Ia,La,Pa,Ta,Da,Ma,Ba,Va,Ka,qa,Za,tn,Ja,zr,ts,is,os,ss,ls,ds,fs,xs,gs,ws,Ss,Cs,Ts,Es,Ei,Fs,Ds,Hs,Ms,Ws,js,Fi,Xs,Ys,Qs,eu,au,ta,uu,hu,cu,hr,mu,bu,vu,Iu,Pu,Tu,Lu,$u,cr,Nu,_u,Ou,Uu,Xt,Hu,Ku,Yu,Ju,nl,rl,al,ul,dl,fl,yl,bl,vl,kl,Il,Pl,Qi,th,rh,ah,ru,Tl,El,Ml,Bl,jl,Xl,Yl,Zl,Jl,uh,ia,hh,ch,fh,Hl,wh,kh,oi,Ih,zh,yu];for(const Hp of Th)(0,u.tAK)(Hp);
/**
    * @license
