 ...
 * =============================================================================
 */
const{mx:ln,ct:hn,YG:dn,hH:cn,z3:pn,sG:fn,uM:mn,vS:gn,C1:yn,qB:xn,GG:wn,lg:bn,rq:vn,cu:Sn,WR:kn,px:Cn,jC:In,He:Rn,hE:zn,BF:Pn,Dk:An,cl:Tn,_B:Ln,qy:$n,Zy:Fn,bu:Nn,dH:En,HS:_n,eW:Dn,GK:Mn,dl:On,Dw:Bn,xT:Un,_X:Wn,wz:Vn}=un,Hn=an({opType:$e.ABS,cpuKernelImpl:En}),Gn={kernelName:u.ljI,backendName:"webgpu",kernelFunc:Hn},Kn=an({opType:$e.ACOS}),jn={kernelName:u.Vvy,backendName:"webgpu",kernelFunc:Kn},Xn=an({opType:$e.ACOSH}),qn={kernelName:u.PH8,backendName:"webgpu",kernelFunc:Xn},Zn=sn({opType:te.ADD,cpuKernelImpl:ln,supportsComplex:!0}),Yn={kernelName:u.OMN,backendName:"webgpu",kernelFunc:Zn};
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function _i(e){const{inputs:t,backend:n,attrs:i}=e,{x:r}=t,{filterSize:o,strides:a,pad:s,dimRoundingMode:l}=i,h=1,d=u.C0T.computePool2DInfo(r.shape,o,a,h,s,l);return Ei(r,d,"avg",n)}const Di={kernelName:u.ho8,backendName:"webgpu",kernelFunc:_i};
/**
 * @license
 ...
 * =============================================================================
 */
function Da(e){const{inputs:t,backend:n,attrs:i}=e,{x:r,filter:o,bias:a,preluActivationWeights:s}=t,{strides:l,pad:h,dataFormat:d,dilations:c,dimRoundingMode:p,activation:f,leakyreluAlpha:m}=i,g=u.C0T.convertConv2DDataFormat(d),y=u.C0T.computeConv2DInfo(r.shape,o.shape,l,c,h,p,!1,g);return Br({x:r,filter:o,convInfo:y,backend:n,bias:a,preluActivationWeights:s,leakyreluAlpha:m,activation:f})}const Ma={kernelName:u.aAr,backendName:"webgpu",kernelFunc:Da};
/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Es(e){const{inputs:t,backend:n,attrs:i}=e,{x:r}=t,{filterSize:o,strides:a,pad:s,dimRoundingMode:l}=i,h=1,d=u.C0T.computePool2DInfo(r.shape,o,a,h,s,l);return Ei(r,d,"max",n)}const _s={kernelName:u.t3d,backendName:"webgpu",kernelFunc:Es};
/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Tu(e){const{inputs:t,backend:n,attrs:i}=e,{x:r}=t,{axis:o,keepDims:a}=i;return ui(r,o,a,"prod",n)}const Lu={kernelName:u.kdj,backendName:"webgpu",kernelFunc:Tu},$u=e=>{const{backend:t,attrs:n}=e,{start:i,stop:r,step:o,dtype:a}=n,s=$n(i,r,o,a);return t.makeTensorInfo([s.length],a,s)},Fu={kernelName:u.Q6t,backendName:"webgpu",kernelFunc:$u},Nu=sn({opType:te.DIV}),Eu={kernelName:u.sDr,backendName:"webgpu",kernelFunc:Nu},_u=an({opType:$e.RECIPROCAL}),Du={kernelName:u.huO,backendName:"webgpu",kernelFunc:_u},Mu=an({opType:$e.RELU}),Ou={kernelName:u.fUj,backendName:"webgpu",kernelFunc:Mu},Bu=an({opType:$e.RELU6}),Uu={kernelName:u.P_L,backendName:"webgpu",kernelFunc:Bu};
/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Dl(e){const{inputs:t,backend:n}=e,{data:i,indices:r,segmentIds:o}=t;return _l(i,r,o,!1,n)}const Ml={kernelName:u.L6G,backendName:"webgpu",kernelFunc:Dl};
/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function Ol(e){const{inputs:t,backend:n}=e,{data:i,indices:r,segmentIds:o}=t;return _l(i,r,o,!0,n)}const Bl={kernelName:u.DvZ,backendName:"webgpu",kernelFunc:Ol};
/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * =============================================================================
 */
function oh(e){const{inputs:t,backend:n,attrs:i}=e,{separator:r,nGramWidths:o,leftPad:a,rightPad:s,padWidth:u,preserveShortSequences:l}=i,{data:h,dataSplits:d}=t,c=n.readSync(h.dataId),p=n.readSync(d.dataId),[f,m]=Mn(c,p,r,o,a,s,u,l);return[n.makeTensorInfo([f.length],"string",f),n.makeTensorInfo(d.shape,"int32",m)]}const ah={kernelName:u.YAb,backendName:"webgpu",kernelFunc:oh},sh=sn({opType:te.SUB,cpuKernelImpl:On,supportsComplex:!0}),uh={kernelName:u.PbM,backendName:"webgpu",kernelFunc:sh},lh=an({opType:$e.TAN}),hh={kernelName:u.oFs,backendName:"webgpu",kernelFunc:lh},dh=an({opType:$e.TANH}),ch={kernelName:u.iuW,backendName:"webgpu",kernelFunc:dh};
/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
